...
function createIndiaMap() {
  ...
  const stateData = {
    "IN-AN": {
      ...
      description:
        "A union territory consisting of 572 islands in the Bay of Bengal.",
    },
    "IN-AP": {
      name: "Andhra Pradesh",
    ...
    "IN-AR": {
      ...
      description:
        'A state in northeastern India, also referred to as the "Land of the Rising Sun".',
    },
    "IN-AS": {
      name: "Assam",
      description:
        "A state in northeastern India known for its tea plantations and silk.",
    },
    "IN-BR": {
      name: "Bihar",
      description:
        "A state in eastern India bordering Nepal, known for its ancient heritage.",
    },
    "IN-CH": {
      name: "Chandigarh",
      description:
        "A union territory and capital of the states of Punjab and Haryana.",
    },
    "IN-CT": {
      name: "Chhattisgarh",
      description:
        "A state in central India known for its dense forests and tribal population.",
    },
    "IN-DD": {
      name: "Daman and Diu",
    ...
    "IN-DL": {
      name: "Delhi",
      description:
        "National Capital Territory and home to India's capital New Delhi.",
    },
    "IN-DN": {
    ...
    "IN-GA": {
      name: "Goa",
      description:
        "India's smallest state known for its beaches, nightlife, and architecture.",
    },
    "IN-GJ": {
      name: "Gujarat",
      description:
        "A state on the western coast of India with a long maritime history.",
    },
    "IN-HP": {
      name: "Himachal Pradesh",
      description:
        "A northern Indian state in the Himalayas, known for its scenic mountain views.",
    },
    "IN-HR": {
      name: "Haryana",
    ...
    "IN-KL": {
      name: "Kerala",
      description:
        "A state on India's tropical Malabar Coast known for its backwaters and beaches.",
    },
    "IN-LA": {
      name: "Ladakh",
      description:
        "A union territory established in 2019, known for its high-altitude landscape.",
    },
    "IN-LD": {
      name: "Lakshadweep",
      description:
        "A tropical archipelago of 36 atolls and coral reefs in the Laccadive Sea.",
    },
    "IN-MH": {
      name: "Maharashtra",
    ...
    "IN-ML": {
      name: "Meghalaya",
      description:
        'A state in northeastern India known as the "abode of clouds".',
    },
    "IN-MN": {
      name: "Manipur",
      description:
        "A state in northeastern India with diverse cultures and landscapes.",
    },
    "IN-MP": {
      name: "Madhya Pradesh",
    ...
    "IN-MZ": {
      name: "Mizoram",
      description:
        "A state in northeastern India with rolling hills and valleys.",
    },
    "IN-NL": {
      name: "Nagaland",
      description:
        "A mountainous state in northeast India known for its tribal culture.",
    },
    "IN-OR": {
      name: "Odisha",
      description:
        "An eastern state formerly known as Orissa, known for its tribal cultures and temples.",
    },
    "IN-PB": {
      name: "Punjab",
      description:
        "A state in northwest India known for its fertile lands and vibrant culture.",
    },
    "IN-PY": {
      name: "Puducherry",
      description:
        "A union territory and former French colony on the southeast coast.",
    },
    "IN-RJ": {
      name: "Rajasthan",
      description:
        "India's largest state known for its desert landscapes and grand palaces.",
    },
    "IN-SK": {
      name: "Sikkim",
      description:
        "A northeastern state in the Himalayas bordering Tibet, Bhutan, and Nepal.",
    },
    "IN-TG": {
      name: "Telangana",
      description:
        "A state in southern India formed in 2014, with Hyderabad as its capital.",
    },
    "IN-TN": {
      name: "Tamil Nadu",
      description:
        "A state in southern India known for its Tamil culture and Hindu temples.",
    },
    "IN-TR": {
      name: "Tripura",
      description:
        "A state in northeast India bordered by Bangladesh on three sides.",
    },
    "IN-UP": {
      name: "Uttar Pradesh",
      description:
        "India's most populous state, located in the northern-central part of the country.",
    },
    "IN-UT": {
      name: "Uttarakhand",
      description:
        "A state in northern India carved out of Uttar Pradesh, known for its Himalayan landscapes.",
    },
    "IN-WB": {
      name: "West Bengal",
      description:
        "An eastern state with a cultural heritage and home to Kolkata.",
    },
  };
